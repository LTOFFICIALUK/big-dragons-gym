...
type CTABandProps = {
  ...
  contactInterest?: "pt" | "nutrition" | "membership";
};
...
export const CTABand = ({
  ...
  const primaryLinkHref: LinkHref =
    contactInterest && primaryHref === "/contact"
      ? { pathname: "/contact", query: { interest: contactInterest } }
      : primaryHref;
        ...
        <FadeIn>
          ...
          <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row sm:gap-4">
            {primaryExternalHref ? (
              ...
              <Link href={primaryLinkHref} className="btn-primary min-w-[200px] text-center">
                {primaryLabel}
              </Link>
            )}
            {secondaryLabel && (

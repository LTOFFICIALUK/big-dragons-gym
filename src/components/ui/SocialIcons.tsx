...
/** Monochrome variants for dark backgrounds (footer). */
export const InstagramIconMono = ({ className }: IconProps) => (
  <svg viewBox="0 0 24 24" aria-hidden="true" className={cn("h-6 w-6 shrink-0", className)}>
    <path fill="currentColor" d={INSTAGRAM_GLYPH} />
  </svg>
);

export const FacebookIconMono = ({ className }: IconProps) => (
  <svg viewBox="0 0 24 24" aria-hidden="true" className={cn("h-6 w-6 shrink-0", className)}>
    <path fill="currentColor" d={FACEBOOK_GLYPH} />
  </svg>
);
